...
$toemails[] = array(
				'email' => 'web@shynxl.com', // Your Email Address
				'name' => 'ShynXL' // Your Name
			);
...
$fromemail = array(
				'email' => 'info@vas-global.co.uk', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'VAS Global Limited' // Company Name
			);
...
$recaptcha_secret = '6LeWENcZAAAAAEkQkqCyILt73Tcs-rpVN9X0AYSy'; // Your reCaptcha Secret
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . ' <strong>VAS Global Limited</strong>. All Rights Reserved.';
