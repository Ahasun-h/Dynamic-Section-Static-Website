...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('custom_image/TRAVEL_AND_TOURISM/travel.jpeg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
			<div class="container clearfix">
				<h1>SHYNXL TRAVEL AND TOURISM</h1>
				<span> </span>				
			</div>
		</section>
		<!-- #page-title end -->
	...
	<script>
		...
		// Swap Content
		if ($(window).width() < 768) {
			$('.align-items-center .travel-content-item:nth-child(2)').insertBefore('.align-items-center .travel-content-item:nth-child(1)');
		}

		// Swap Content
		if ($(window).width() < 768) {
			$('.align-items-center .travel-content-item_one:nth-child(2)').insertBefore('.align-items-center .travel-content-item_one:nth-child(1)');
		}
