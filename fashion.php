...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('custom_image/SHYNXL_FASHION_AND_DESIGN/pexels-photo-3641059.jpeg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
			<div class="container clearfix">
				<h1>SHYNXL FASHION AND DESIGN</h1>		
			</div>
	...
	<script>
		// Swap Content
		if ($(window).width() < 768) {
			$('.align-items-center .fashion-content-item:nth-child(2)').insertBefore('.align-items-center .fashion-content-item:nth-child(1)');
		}
