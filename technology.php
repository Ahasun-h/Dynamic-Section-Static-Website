...
<body class="stretched">
	...
	<script>
		// Swap Content
		if ($(window).width() < 768) {
			$('.container .technology-content-item:nth-child(2)').insertBefore('.container .technology-content-item:nth-child(1)');
		}
