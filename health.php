...
<head>
	...
	<!-- jQuery Lightbox Plugin Pretty Photo CSS FILES -->
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('custom_image/HEALTH_AND_BEAUTY/pexels-pineapple-supply-co-204686.jpg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
			<div class="container clearfix">
				<h1>SHYNXL HEALTH AND BEAUTY</h1>
				<span> </span>				
			</div>
		</section>
		<!-- #page-title end -->
	...
	<!-- jQuery Lightbox Plugin Pretty Photo Scripts -->
