...
<head>
	...
	<!-- Stylesheets -->
	<link href="https://fonts.googleapis.com/css?family=Lato:300,400,400i,700|Raleway:300,400,500,600,700,800,900|Poppins:400&display=swap" rel="stylesheet" type="text/css" />
	...
	<style>
		...
		.blurslider-gradient {
			background:-webkit-linear-gradient(left,#3595E5 0%,#57AA50 50%,#3595E5 100%);
			-webkit-background-clip:text;-webkit-text-fill-color:transparent;
		}
		.blurslider-button { background:-webkit-linear-gradient(left,#ffffff 0%,#DBB448 50%,#ffffff 100%); }
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('images/parallax/15.jpg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
			<div class="container clearfix">
				<h1>SHYNXL JEWELRY</h1>
				<span> </span>				
			</div>
